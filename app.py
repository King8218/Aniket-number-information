...
# ---------- CONFIG (Optional: अपनी API Keys यहाँ डालें) ----------
...
<head>
    ...
    <title>🌊 अनिकेत नंबर इंफॉर्मेशन</title>
    <meta name="description" content="अनिकेत नंबर इंफॉर्मेशन - Phone number lookup service. Get operator, circle, location & validity">
    <style>
        /* ===== RESET ===== */
...
<body>
    ...
    <div class="header">
        <div class="logo">
            🌊 अनिकेत <span>नंबर इंफॉर्मेशन</span>
        </div>
    ...
    <div class="footer">
        ...
        &nbsp;•&nbsp; Made with <span class="heart">❤️</span> by अनिकेत
        &nbsp;•&nbsp; ⚡ Hosted on Vercel
    </div>
    ...
    <div class="modal" id="privacyModal">
        <div class="modal-content">
            ...
            <p>Welcome to <strong>अनिकेत नंबर इंफॉर्मेशन</strong>. Your privacy is our priority.</p>
            <ul>
                <li><strong>No Data Collection:</strong> We do NOT collect, store, or share any personal information.</li>
                <li><strong>Local Storage Only:</strong> Your search history is saved locally in your browser.</li>
                <li><strong>No Cookies:</strong> We don't use tracking cookies.</li>
                <li><strong>Public Data Only:</strong> We only show operator, circle, line type.</li>
                <li><strong>No Personal Info:</strong> No names, addresses, emails, or Aadhaar.</li>
                <li><strong>HTTPS Secure:</strong> All communication is encrypted.</li>
            </ul>
            <p>📧 Questions? <strong>support@aniket-ocean.com</strong></p>
    ...
    <div class="modal" id="termsModal">
        <div class="modal-content">
            ...
            <p><strong>Last Updated:</strong> July 2025</p>
            <p>By using <strong>अनिकेत नंबर इंफॉर्मेशन</strong>, you agree to:</p>
            <ul>
                ...
                <li><strong>No Warranty:</strong> Service provided "as is".</li>
    ...
    <script>
        ...
        function loadHistory() {
            try {
                const history = JSON.parse(localStorage.getItem('aniketOceanHistory') || '[]');
        ...
        function saveHistory(number) {
            try {
                let history = JSON.parse(localStorage.getItem('aniketOceanHistory') || '[]');
                history = history.filter(n => n !== number);
                history.push(number);
                if (history.length > 20) history = history.slice(-20);
                localStorage.setItem('aniketOceanHistory', JSON.stringify(history));
                loadHistory();
            } catch(e) { /* ignore */ }
        }

        function clearHistory() {
            localStorage.removeItem('aniketOceanHistory');
            loadHistory();
        }
